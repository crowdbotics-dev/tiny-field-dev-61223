"""
Django settings for tiny_field_dev_61223 project.
...
ROOT_URLCONF = 'tiny_field_dev_61223.urls'
...
WSGI_APPLICATION = 'tiny_field_dev_61223.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tiny_field_dev_61223 API",
    "DESCRIPTION": "API documentation for tiny_field_dev_61223 App",
    "VERSION": "v1",
}
